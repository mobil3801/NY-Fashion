  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">{t('purchases')}</h1>
          <p className="text-gray-600 mt-2">Track your purchase orders and inventory</p>
        </div>
      ...
      <Card className="rounded-3xl border-0 shadow-sm">
        <CardHeader>
          ...
          <CardDescription>Manage your supplier purchases</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="text-center py-12">
            ...
            <h3 className="text-xl font-semibold mb-2">Purchase management coming soon</h3>
            <p className="text-gray-600">This feature will help you track and manage all your supplier purchases.</p>
          </div>
        </CardContent>
      </Card>
    </div>);
