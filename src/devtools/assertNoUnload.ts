...
if (import.meta.env?.DEV) {enableUnloadProtection({ throwOnUnload: true, throwOnBeforeUnload: false, // Allow beforeunload for form protection
      logWarnings: true, allowedOrigins: ['easysite.ai', 'googleapis.com'] // Allow certain third-party scripts
    });}export default { enableUnloadProtection, disableUnloadProtection, checkForExistingUnloadHandlers, reportUnloadHandlers };