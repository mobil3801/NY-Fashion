...
async function deleteProductImage(imageId) {
  try {
    ...
    `;await window.ezsite.db.query(reorderQuery, [image.product_id, image.sort_order]);return { message: 'Image deleted successfully', deletedImageId: imageId };} catch (error) {
